...
import WorkPlanReportForm from "../forms/WorkPlanReportForm";
...
const WorkPlanReportModal: React.FC<Props> = ({ setIsActive }) => {
    ...
    return (
        <ModalLayout ref={modalRef}>
            ...
            <ModalFooter>
                <ActionButton colorType="add">Скачать</ActionButton>
            </ModalFooter>
        </ModalLayout>
    );
};

export default WorkPlanReportModal;
